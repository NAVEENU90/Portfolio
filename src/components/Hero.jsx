...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="section-padding pt-28 md:pt-36 lg:pt-44 relative"
      ...
      <div className="container-custom flex flex-col items-center text-center gap-8">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-sm md:text-base text-slate-500 leading-relaxed">
            I design and build modern web applications with React, Node.js,
            Express, and MongoDB — blending clean engineering with playful,
        ...
        >
          ...
          <a
            href="/Naveen_U_Resume.pdf"
            download
            className="inline-flex items-center justify-center gap-2 rounded-full border border-black/[0.08] bg-white/70 px-6 py-3 text-sm font-medium text-slate-700 hover:border-violet-400/30 hover:bg-white transition-all duration-300"
          >
            <Download size={16} />
        ...
        <motion.div
          className="flex flex-col gap-3 pt-4 w-full max-w-lg"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.4, delay: 0.35 }}
        >
          <p className="text-[11px] text-slate-400 text-center uppercase tracking-widest">
            Trusted by teams & experiments at
          </p>
